...
(() => {
  const STYLES = [
    ...
    { slug: "cathedral", name: "Cathedral", tag: "stunning",
      desc: "Candlelit stone in the brand kit: deep teal ground, gold hairlines, the real hands-and-flame mark, and every licensed photo inside an arch like the real one.",
      fonts: "STIX Two Text + Montserrat (brand kit)", colors: ["#082625", "#d8c971", "#117575", "#169999", "#ecebe3"] },
    ...
    { slug: "nouveau", name: "Nouveau", tag: "bedazzled",
      desc: "A Mucha poster: flat plum, a gold whiplash cartouche that draws itself, enamel irises and peacock eyes.",
      fonts: "Gilda Display + Alegreya Sans + Pinyon Script", colors: ["#5e3552", "#2f2a2a", "#b8892e", "#4d7d76", "#ecdfc4"] },
    { slug: "talavera", name: "Talavera", tag: "bedazzled",
      desc: "A Puebla tile wall in the Texas sun: cobalt, marigold and turquoise glaze, and a wall that paints itself from one tile.",
      fonts: "Yeseva One + Mulish", colors: ["#f6f1e4", "#123a8a", "#1f4aa3", "#e5b431", "#5fb3b3"] },
    { slug: "vellum", name: "Vellum", tag: "bedazzled",
      desc: "Illuminated manuscript: lapis title page, gilded versals before miniatures, vermilion rubrics and catchwords.",
      fonts: "Uncial Antiqua + Gentium Book Plus", colors: ["#efe3c6", "#2a1f14", "#c9971c", "#1f3f8f", "#a52a2a"] },
    { slug: "enamel", name: "Enamel", tag: "bedazzled",
      desc: "Fabergé jewel box: emerald guilloché, rose-gold wire, and every photo fired into an enamel egg or cameo.",
      fonts: "Bellefair + Outfit", colors: ["#0f4d3a", "#f6f1e8", "#d7a084", "#a8203a", "#1c3f8a"] },
    { slug: "curtain", name: "Curtain", tag: "bedazzled",
      desc: "Opera house: crimson velvet and gilt frame the hero, then ivory programme card with footlights and a spotlight.",
      fonts: "Cinzel + Lora", colors: ["#f2e8d8", "#2a0c15", "#8c1d2f", "#d4a853", "#4a6b7a"] },
    { slug: "loom", name: "Loom", tag: "bedazzled",
      desc: "Denim-and-linen loom: her words shuttled through the warp, knots that untie, a shuttle that leaves copper weft behind.",
      fonts: "Anybody + Lexend", colors: ["#f3eee3", "#2b3a5c", "#b8622f", "#a9505f", "#c9b48a"] },
    { slug: "lenticular", name: "Lenticular", tag: "bedazzled",
      desc: "Holographic proof sheet: chrome-foil type on pearl grey, oil-slick bands and lenticular cards that catch light as you scroll.",
      fonts: "Schibsted Grotesk + Instrument Sans + Martian Mono", colors: ["#e6e8ec", "#14161c", "#b9bec8", "#2fb3a6", "#c94b9a"] },
    { slug: "meander", name: "Meander", tag: "bedazzled",
      desc: "Survey map: chart paper, sienna contours, and one blue river that winds the whole page to a still pool.",
      fonts: "Sorts Mill Goudy + Spectral SC + Barlow", colors: ["#f7f5ef", "#2a2a26", "#b57b3c", "#2b6fae", "#c8663b"] },
    { slug: "popup", name: "Popup", tag: "bedazzled",
      desc: "Pop-up paper theatre: kraft covers, cut-paper hills, and every card rising on a visible hinge with a pull-tab.",
      fonts: "Zilla Slab + Atkinson Hyperlegible", colors: ["#f6f3ee", "#33404d", "#d19a95", "#7c8fa6", "#c9a577"] },
    { slug: "nightgarden", name: "Nightgarden", tag: "bedazzled",
      desc: "Walled garden at moonrise: green-black, silvered Maria, moonflowers unfurling on scroll, a paper lantern that turns per step.",
      fonts: "Ovo + Hanken Grotesk", colors: ["#0e1a15", "#f2efe6", "#b8c4d6", "#e6a9b8", "#d9c27a"] },
  ];
