// HTTP Basic Auth gate for /grants/* paths.
//
// Set env vars in Netlify dashboard:
//   GRANTS_PASSWORD  — required. The shared password.
...
export default async (request, context) => {
  ...
  if (!expected) {
    return new Response(
      "Grants page is misconfigured: GRANTS_PASSWORD env var is not set.",
...
function unauthorized() {
  return new Response("Authentication required.", {
    status: 401,
    headers: {
      "WWW-Authenticate": 'Basic realm="HAND Grants", charset="UTF-8"',
