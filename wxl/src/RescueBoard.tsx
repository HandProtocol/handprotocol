...
export function RescueBoard({ dbConfigured, canWrite, notify, onAuthRequired, onContributorSetup }: RescueBoardProps) {
  ...
  return <>
    ...
    {!dbConfigured && <section className="panel rescue-empty"><AlertTriangle size={25} /><h3>Rescue operations need the WXL database.</h3><p>Configure Supabase and apply migration 028 before testing real rescue coordination.</p></section>}
