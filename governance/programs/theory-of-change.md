...
A theory of change is the explicit argument linking HAND's activities to the outcomes HAND seeks. It is the answer to the funder question: *if I give you money, why do I believe it will produce the change you describe?*

This document is honest about the strength of the evidence behind each link in the chain, and explicit about what HAND has not yet proven.
...
a. **Founder coaching.** Other organizations (CompassPoint, accelerators) do this well.
...
e. **One-time project work.** The "build and bounce" model is what HAND was built to displace.
...
- Contributors report meaningful, well-matched engagements.
- Contributors return for second engagements at high rates (target: 70%+ year-over-year retention).
- Contributors describe HAND as a curated experience, distinct from open pro-bono marketplaces.
...
- 501(c)(3) status filed and granted.
- Public support test met annually.
- Funder relationships diversified across community foundations, trust-based funders, and AI-for-good funders.
- Staff team grown to 3-5 people sustainable on a balanced revenue mix.
- Brand maintained as distinctive in voice and posture.
...
**The link:** Publishing methodology, evaluation, code, and quarterly reports allows adjacent organizations to adopt the approach, multiplying impact beyond what HAND alone could deliver.

**Evidence:** Open-source software, open-source curriculum, and open-source policy research all have track records of multiplying impact when communities exist to adopt and adapt. Whether the same dynamic works for nonprofit operational methodology is less clear.

**Honest assessment:** Plausible in 5-10 year horizon; tested by whether adjacent organizations actually adopt the approach within 3 years.

## What HAND has not yet proven
...
e. HAND has not yet proven the unit economics: that the cost of a three-year accompaniment can be supported by realistic funder revenue.

The 501(c)(3) filing raise, the McGovern letter, and the strategic plan ([`strategic-plan-2026-2028.md`](strategic-plan-2026-2028.md)) are designed to produce the evidence over the next three years that turns this theory into a track record.
