...
> Governs what kinds of gifts HAND Protocol Foundation accepts, declines, or requires Board review for. Required on Form 990 Schedule M line 31.
...
a. Ensure all gifts further the Corporation's exempt purpose.

b. Protect the Corporation from liability and reputational risk associated with problematic gifts.

c. Provide donors with consistent, transparent treatment.
...
d. **Donor-advised fund (DAF) grants** from any IRS-recognized DAF sponsor.

e. **Workplace giving** through Benevity, YourCause, or similar platforms.
...
a. **In-kind goods** valued in excess of $1,000.
...
h. **Bequests, charitable remainder trusts, charitable lead trusts, life insurance policies, or other planned-giving instruments.**
...
a. Any gift creating an ongoing financial obligation for the Corporation (e.g., real property requiring maintenance, art requiring storage and insurance).

b. Any gift with restrictions affecting strategy, programs, or hiring.
...
b. **Wallet management.** A dedicated multi-signature wallet under the Corporation's exclusive control, with at least two signers required for transfers. Wallet addresses published.

c. **Conversion.** By default, cryptocurrency donations are converted to USD within **30 days** of receipt to avoid market exposure. The Treasurer may extend this period in limited cases (gift conditioned on holding period; large gift requiring market-sensitive execution).

d. **Valuation.** At fair market value on the date of receipt, per IRS Notice 2014-21 (cryptocurrency treated as property).

e. **Substantiation.** Cryptocurrency gifts over $5,000 require a qualified appraisal and Form 8283 Section B (per IRS Chief Counsel Memorandum 202302012, January 2023). The Corporation acknowledges receipt of the gift but cannot substantiate the deduction value for the donor.
...
- Corporation's name.
- Amount of cash contributed, or description of non-cash property (without dollar value).
- Statement of whether any goods or services were provided in exchange (and if so, their value), or statement that no goods or services were provided.

b. **Quid pro quo gifts over $75** require disclosure of the deductible portion.

c. **Gifts over $250** require the substantiation language ("no goods or services received" or description) per IRC §170(f)(8).

d. **Acknowledgments delivered** by mail or email within **30 days** of receipt.

e. **Non-cash gifts over $5,000** require Form 8283 Section B; HAND signs Part IV acknowledging receipt but does not provide the appraisal (that's the donor's responsibility).
...
b. **Anonymity** respected on donor request.

c. **Naming gifts** require Board approval, written naming agreement, and a name-change procedure if the donor's circumstances later create a reputational conflict.
...
c. **Donor file.** Maintained per the Document Retention Policy. Includes giving history, acknowledgments, correspondence, restrictions, recognition preferences.
...
b. **Exceptions** are made for:
- Duplicate processing errors.
- Donor death within 30 days of a recurring gift cycle, on family request.
- Demonstrated processor error.
...
b. Disclosed conflicts do not automatically preclude the gift but may require committee deliberation without the conflicted director.

## Open questions

- **Cryptocurrency cold storage.** Wallet setup decisions (Gnosis Safe, hardware wallet custody, multi-sig threshold) deferred to a separate operational protocol.
...
*Template references: National Council of Nonprofits Gift Acceptance Policies; AFP (Association of Fundraising Professionals) Donor Bill of Rights; IRS Pub. 1771 (Charitable Contributions Substantiation and Disclosure); IRS Notice 2014-21 (cryptocurrency).*
