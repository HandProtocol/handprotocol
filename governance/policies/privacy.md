...
> How HAND Protocol Foundation collects, uses, stores, and shares personal information. Has both a public-facing component (the privacy notice published on the website) and an internal-procedures component (how staff handle data).
...
The Corporation does **not** use personal information for:

- Selling, renting, or trading to third parties.
- Cross-organizational advertising or marketing.
- Building shared profiles with other organizations.
...
b. **Encryption at rest** for production databases containing personal information.

c. **Access controls.** Personnel access on a need-to-know basis. Role-based access where systems permit.

d. **Multi-factor authentication** on all accounts handling personal information.

e. **Vendor selection** favors vendors with strong privacy practices (SOC 2 Type II certification or equivalent where feasible).

f. **Backup and recovery** procedures protect against data loss; backups subject to the same protections as production data.
...
d. Personnel records: 5 years post-separation.
...
a. **Right to know** what information the Corporation holds.

b. **Right to access** a copy of that information.

c. **Right to correct** inaccurate information.

d. **Right to delete** information, subject to legal-retention requirements.

e. **Right to opt out** of communications at any time.
...
b. For EU/UK residents, the Corporation relies on Standard Contractual Clauses where applicable and processes only minimum necessary data.
...
- **Privacy notice for the website (public version).** The above is the full internal policy; a shorter, plain-language version belongs on the website at `/privacy`. Draft separately.
- **Data Protection Officer / Privacy Officer designation.** Not required by most U.S. law at HAND's size, but designating one person (likely the Executive Director or Treasurer) clarifies accountability.
- **Cookie banner.** If the website ever uses any analytics with identifiers, a banner may be required for EU visitors. Current stack (no third-party tracking) avoids the requirement.
- **Texas Data Privacy and Security Act applicability.** TDPSA exempts small businesses processing data of fewer than 100,000 consumers; HAND falls well below. Still adopting the protections as a posture.
- **CCPA / CPRA applicability.** Applies to businesses meeting thresholds; nonprofits generally exempt unless processing personal data for a for-profit affiliate. Still adopting the rights as a posture.
