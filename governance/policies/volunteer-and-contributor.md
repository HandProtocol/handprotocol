# Volunteer and Contributor Policy

> Establishes how Contributors join HAND's resource pool, what HAND offers them, what HAND expects of them, and the legal framework that protects everyone involved.
...
a. Establishes how Contributors join the pool.

b. Defines the relationship between Contributors and the Corporation.

c. Sets expectations and protections for Contributors.

d. Sets expectations and protections for the Corporation.
...
b. **Skills inventory.** Free-text plus structured options; informs matching.

c. **Capacity statement.** Hours per month available, duration of commitment willing to make.

d. **Code of Ethics acknowledgment.** Required.

e. **Reference check** for Contributors offering services with material trust implications (any work in clinical, legal, financial, or organizational-leadership domains): at least two references contacted before first engagement.

f. **Conflict-of-interest screening** if the Contributor has employment or affiliations with peer organizations, funders, or other entities that interact with HAND.
...
c. Receives access to relevant systems (project management tool, communications channels).

d. Participates in an orientation conversation with HAND staff.
...
c. **Recognition** appropriate to the Contributor's preference (public, anonymous, opt-out).

d. **Insurance coverage** to the extent of the Corporation's general liability and any volunteer-specific coverage.

e. **Professional development**, including peer-cohort connections with other Contributors.

f. **References and recommendations** at the Contributor's request.

g. **Honoraria, where appropriate.** Some Contributor engagements may include modest honoraria (e.g., $100–500 for an intensive workshop). Honoraria are documented and disclosed; recipients receive Form 1099-NEC if cumulative payments exceed $600 in a calendar year.
...
b. **Reliability.** Show up to commitments, communicate when constraints arise.
...
b. **Honoraria do not convert volunteer status to employee status.** Modest honoraria, reimbursements, and recognition do not create an employment relationship.

c. **Independent contractor classification.** Where a Contributor provides services for compensation in a structured contractor role (not pool volunteer), an independent-contractor agreement governs, and IRS 20-factor and DOL economic-realities tests determine proper classification.
...
b. **Federal Volunteer Protection Act** (42 U.S.C. §14501 et seq.) provides additional liability protection for volunteers acting within the scope of their volunteer role.

c. **D&O and general liability insurance** carried by the Corporation extends to Contributors acting in their authorized role.

d. **Indemnification** under Bylaws Article VIII covers Contributors to the extent permitted by law.

e. **Limitations.** Liability protections do not apply to:
- Acts outside the scope of volunteer responsibilities.
...
a. **Background check** required for direct unsupervised work with minors or other vulnerable populations. Process complies with Fair Credit Reporting Act if a third-party screening service is used.
...
b. **Anniversary recognition** for Contributors continuing in the pool past one year.

c. **Public recognition events** as resources permit.
...
c. **Brand and design services.** Contributing designers retain copyright, license to HAND under permissive terms (or assign on case-by-case basis with documentation).

d. **Therapist or licensed clinical services.** Generally not within HAND's program scope. If a Contributor offers such services, the services are provided through the Contributor's separate practice, not through HAND.

## Open questions

- **Honoraria threshold.** Drafted at $100–500. Some peer orgs go to $1,000 for intensive single-engagement workshops. Adjust by board policy.
- **Background-check provider.** Contracted relationship to establish before first vulnerable-population engagement.
- **Contributor handbook.** Drafted as a plain-language derivative of this Policy. Produce as a separate artifact for actual use.
- **Pool size cap.** No explicit cap drafted. Realistically, HAND's first year supports 10–25 active Contributors. A formal cap is unnecessary until matching capacity is strained.
- **Pro bono valuation.** Hours contributed are tracked. Whether to recognize as in-kind for FASB depends on whether services would otherwise be purchased and whether Contributor has the relevant credentials. Bookkeeper to document case-by-case.

---

*Template references: National Council of Nonprofits Volunteer Management resources; Points of Light volunteer management standards; Texas Charitable Immunity and Liability Act; Federal Volunteer Protection Act.*
