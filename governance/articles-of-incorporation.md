# Certificate of Formation: HAND Protocol Foundation

> Texas nonprofit corporation. The certificate of formation is the public charter, filed with the Texas Secretary of State on Form 202 under Chapter 22 of the Texas Business Organizations Code. The language below is drafted to satisfy both Chapter 22 and the IRS requirements for 501(c)(3) qualification (Pub. 557, sample Articles).

**Status:** Draft v0.1 · May 2026 · Pre-filing · Pending counsel review

**Drafting note.** Texas Form 202 is a short fill-in form. The substantive content below is what populates the form's narrative blocks (purpose, dissolution, directors), plus the IRS-mandated 501(c)(3) language that must be included for the federal exemption application to succeed. Anything tagged **[Form 202 field]** indicates a literal box on the SOS form.
...
| Name | Address |
|---|---|
| [Director 1 name] | [Street address, City, State, ZIP] |
| [Director 2 name] | [Street address, City, State, ZIP] |
| [Director 3 name] | [Street address, City, State, ZIP] |
...
> [Registered office street address, City, Texas, ZIP]

The name of the corporation's registered agent at that office is:
...
| Name | Address |
|---|---|
| [Organizer name] | [Street address, City, State, ZIP] |
...
Before submitting Form 202 to the Texas Secretary of State:

- [ ] Counsel has reviewed the certificate and confirmed Texas BOC Chapter 22 compliance.
- [ ] Counsel has confirmed the purpose and dissolution clauses contain the IRS-mandated 501(c)(3) language (Pub. 557).
- [ ] Registered agent has executed Form 401-A consent and the original is on file with HAND.
- [ ] Three initial directors have agreed in writing to serve and have provided home or business addresses.
- [ ] Filing fee of $25 (plus 2.7% credit card convenience fee if filed via SOSDirect) is ready.
- [ ] The organization's intended name has been searched on SOSDirect and is "distinguishable on the records."
- [ ] The organizer has identified the date for the initial organizational meeting (must occur after filing, ideally within 30 days, to adopt bylaws and elect officers under §22.107).
- [ ] An EIN application (Form SS-4) is prepared, to be filed immediately after the certificate filing receipt is received.

## Open questions

- **Director identities.** The three initial directors need to be confirmed in writing before filing. Founder's preference, board chair sequence, and lived-experience composition decided by founder before next governance review.
- **Registered agent.** Two options: founder serves as own registered agent (cheapest, but founder's home address becomes a public record), or HAND contracts a commercial registered agent service ($50–$200/year, keeps founder's address private). Recommended path is commercial; weigh privacy against cost.
- **Members vs no-members structure.** Drafted as no-members (board-governed) above. Texas allows member corporations, but members add governance complexity and IRS scrutiny. **Stay no-members unless a clear reason emerges to add a member class.**
- **Name reservation.** Form 501 reserves the name for 120 days for a $40 fee. Useful if Form 202 won't be filed within a week of intent. Skip if filing is imminent.

---

*Pre-filing draft. The actual Form 202 is a Texas SOS template with specific layout; this document supplies the substantive language for each field. Form: `sos.state.tx.us/corp/forms/202_boc.pdf`. Instructions: `sos.state.tx.us/corp/instructions/202.shtml`.*
