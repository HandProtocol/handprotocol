...
export function SimpleExperience({ initialIntent }: { initialIntent: ConsumerIntent }) {
  ...
  const [foodDraft, setFoodDraft] = useState(() => {
    try {
      const saved = sessionStorage.getItem('yuhm:food-draft')
  ...
  const [locationPromptOpen, setLocationPromptOpen] = useState(() => initialIntent === 'food' && sessionStorage.getItem('yuhm:location-choice') !== 'complete')
  ...
  const [requestDraft, setRequestDraft] = useState(() => {
    try {
      const saved = sessionStorage.getItem('yuhm:request-draft')
