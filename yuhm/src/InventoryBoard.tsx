...
export function InventoryBoard({ dbConfigured, canWrite, notify, onAuthRequired }: Props) {
  ...
  if (!dbConfigured) return <section className="panel inventory-empty"><AlertTriangle size={25} /><h2>Inventory needs the yuhm database.</h2><p>Configure Supabase and apply migration 031 before custody testing.</p></section>
