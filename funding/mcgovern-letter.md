...
HAND Protocol began in August 2024 as Web3 fundraising infrastructure for regenerative impact work. Over the next year we learned that the impact founders, small-business owners, food-sovereignty collectives, and neighborhood organizers we were trying to support were not crypto-native, and that crypto was the wrong starting tool. In early 2026 we pivoted. HAND now serves impact entrepreneurs, community-rooted small businesses, and grassroots organizations. The lines between them are porous, and many of our Reciprocates live in two of these worlds at once. We operate a curated resource pool, with long-term web, brand, and operational accompaniment as the core promise. We are filing for 501(c)(3) status in 2026 and have published three discovery documents (vision, models, landscape) at handprotocol.org/discovery as the evidence base for the work.
