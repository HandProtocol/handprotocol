...
## 1. Texas Nonprofit Incorporation (Chapter 22, BOC)

### Statutory framework

HAND Protocol Foundation will be a domestic nonprofit corporation governed by **Texas Business Organizations Code, Title 2, Chapter 22**. The full text is published by the Texas Legislature at `statutes.capitol.texas.gov/Docs/BO/htm/BO.22.htm`.

### Directors (§22.204)

- **Minimum three (3) directors** required. The certificate of formation or bylaws control any larger number; the BOC imposes no upper limit.
- **No residency, age, or citizenship requirement** under state law. The organization may impose its own qualifications in the certificate or bylaws.
- After filing, the named initial directors must hold an **organization meeting** to adopt bylaws and elect officers (§22.107).
- Directors may be divided into classes.

### Officers (§22.231)

- **President and Secretary are required.** A vice president, treasurer, and other officers are permitted but not required.
- The same person may hold multiple offices, **but the same person may not be both president and secretary** (a common requirement to ensure separation in signing/attesting).

### Certificate of Formation (Form 202)

- Filed with the **Texas Secretary of State**, Corporations Section.
- **Filing fee: $25** (paper or SOSDirect; SOSDirect adds a 2.7% credit-card convenience fee).
- Required contents include: corporate name (with "must be distinguishable on the records"); statement of nonprofit status; whether the corporation will have members; purpose clause; **registered agent and registered office in Texas**; names and addresses of initial directors; organizer's signature.
- For 501(c)(3) qualification, the purpose clause and the dissolution clause should contain the IRS-mandated language found in IRS Publication 557 (charitable/religious/educational purpose limitation + asset distribution to another 501(c)(3) upon dissolution).
- Form and instructions: `sos.state.tx.us/corp/instructions/202.shtml`.

### Registered agent (§5.201 et seq.)

- Must maintain a **physical street address in Texas** (the "registered office") where the agent can be served during business hours.
- **P.O. boxes, mailbox services, and virtual addresses are explicitly prohibited.** UPS Store and similar commercial mailboxes do not qualify unless the commercial enterprise itself acts as registered agent.
- Agents designated on or after January 1, 2010 must consent in writing or electronically (SOS Form 401-A).
...
### Texas sales tax exemption (Form AP-205)

- Alternative path for nonprofits that qualify as "charitable" under Texas law even without (or before) IRS recognition. Requires that the organization devote "all or substantially all" of its activities to alleviating poverty, disease, pain and suffering, etc.
- **For HAND, the recommended path is AP-204 after receiving the IRS Determination Letter**, because the mission scope is broader than the AP-205 standard and the 501(c)(3) letter is the cleanest qualifier.
- Reference: `comptroller.texas.gov/forms/ap-205.pdf`.

### Texas periodic report (Form 802, §22.357)

- Filed with the SOS **only on request**, not more than once every four years.
- Lists current names and addresses of all directors and officers.
- **Filing fee: $5.** Late penalty: $1/month up to $25 maximum; failure to file within 30 days of notice can cause forfeiture of corporate rights.
- Reference: `sos.state.tx.us/corp/instructions/802.shtml`.

---

## 2. IRS 501(c)(3) Filing Path

### Form 1023 vs. Form 1023-EZ

| | Form 1023-EZ | Form 1023 (long form) |
|---|---|---|
| **User fee** | **$275** | **$600** |
| **Length** | 3 pages + worksheet | ~28 pages + schedules |
| **Eligibility cap** | Projected gross receipts **≤ $50,000** in each of next 3 years; total assets ≤ $250,000 | No cap |
| **Required attachments** | None (uploaded; no narrative) | Full narrative, financials, bylaws, COI policy |
| **IRS processing time** | 2–4 weeks typical | 3–9+ months typical |
| **Effective-date flexibility** | Loss of retroactive date option if >27 months past formation | Full retroactive date available via Schedule E |

Both are filed via **Pay.gov**. Fee is **non-refundable** even if withdrawn or denied.

**Recommendation for HAND:** HAND should file the **full Form 1023**, not 1023-EZ. Three reasons:
1. Projected receipts likely exceed $50K once Foundation-tier campaign closes.
2. The narrative is the document funders most often request as the cleanest articulation of mission/programs.
3. The 1023 forces drafting the policies and procedures funders look for; the EZ short-circuits that work.

Form 1023 instructions: `irs.gov/pub/irs-pdf/i1023.pdf` (Rev. December 2024).
Form 1023-EZ instructions: `irs.gov/pub/irs-pdf/i1023ez.pdf` (Rev. January 2025).
...
The advance ruling period has been eliminated; new organizations are presumed to be public charities for their first **5 years**, then tested annually on a **5-year rolling basis** beginning year 6. Failure means reclassification as a private foundation, which carries Form 990-PF filing burdens, excise taxes, and reduces the donor deductibility ceiling.
...
**Practical implication for HAND:** angel-number tier gifts ($222,222, $77,444, $22,777 etc.) from individual donors generally count fully if each donor's cumulative gifts stay under 2% of 5-year total support. A single anchor gift larger than that 2% threshold is counted only up to the 2% cap toward the public support fraction, design the donor pyramid accordingly.

---

## 3. Required Policies (Form 990 Part VI & Form 1023)

Form 990 Part VI is the governance disclosure section. The IRS position (per the 2009 CPE governance training and Part VI FAQs) is that these policies are "generally not required under the Code, but the IRS considers such policies and procedures to generally improve tax compliance." In practice, foundations treat "yes" answers as table stakes.

### Required (or de facto required) policies

| Policy | Legally required? | Form 990 Part VI line | Why it matters |
|---|---|---|---|
| **Conflict of Interest policy** | Effectively required by Form 1023 (Appendix A sample provided by IRS) | VI-B line 12a–12c | Required attachment to long-form 1023; covers IRC §4958 intermediate sanctions and the rebuttable-presumption procedure |
...
- Form 990 Schedule M is required if the organization reports **>$25,000 in noncash contributions** during the year, or receives art, historical assets, or qualified conservation contributions.
- For **individual non-cash gifts >$5,000**, donors must obtain a **qualified appraisal** and file IRS Form 8283 Section B; HAND must sign Part IV acknowledging receipt.
- For gifts >$500,000, the appraisal itself must be attached to the donor's return.
- Schedule M line 31 asks if the organization has a gift-acceptance policy requiring review of non-standard contributions ("non-standard" = no ready market, value difficult to ascertain, not reasonably expected to further exempt purpose). **Strong "yes" expected.**

### Sample policy templates

- IRS sample Conflict of Interest Policy: Appendix A of Form 1023 instructions (`irs.gov/pub/irs-pdf/i1023.pdf`).
- BoardSource and the National Council of Nonprofits both publish whistleblower and document-retention templates (`councilofnonprofits.org/running-nonprofit/governance-leadership/good-governance-policies-nonprofits`).

---

## 4. Grant-Readiness Standards

Trust-based and traditional funders alike converge on a roughly standard due-diligence packet. The set below is synthesized from MacKenzie Scott / Yield Giving's Open Call, Austin Community Foundation's application portal, the Hogg Foundation's Fluxx requirements, and standard grants management practice.

### Standard application attachments

1. **IRS Determination Letter** (501(c)(3) status confirmation).
2. **Most recent IRS Form 990** (or 990-EZ / 990-N for very small orgs).
3. **Audited financial statements** for the most recent fiscal year (or reviewed financials for orgs <$500K revenue; some funders accept compiled statements until $250K).
4. **Current operating budget**, board-approved.
5. **Year-to-date actual income and expenses** (Statement of Activities).
6. **Statement of Financial Position** (balance sheet).
7. **List of board of directors** with affiliations and terms.
8. **List of major funders** for the current and prior year.
9. **Organizational chart**.
10. **Strategic plan** (for larger funders; trust-based funders less likely to demand).
11. **Logic model or theory of change** (common for foundation funders).
...
### What trust-based funders actually look for
...
**Austin Community Foundation:** Open application; eligibility includes 501(c)(3)s **or fiscally sponsored projects**; minimum org budget **$50,000**; minimum **2 years operating history**; geographic scope = Bastrop, Burnet, Caldwell, Hays, Travis, or Williamson counties. Average grant $25,000 (range $1,000–$75,000). Recommends applying for ≤30% of annual budget. 4–5 month processing timeline.

**St. David's Foundation:** ~$100M/year grantmaker in 5-county Central Texas region. **By invitation only**, but program officers will discuss eligibility. Strong fit for HAND's healer-pillar work given the foundation's mental-health and culturally-responsive-care priorities.

**Headwaters Foundation for Justice (Minneapolis):** Prioritizes BIPOC-led grassroots organizing. Multi-year general operating support. Movement-aligned model; **HAND's natural philosophical kin** but geographic limitation to Minnesota means this is more useful as a reference model than a direct funder.

### Common due-diligence questions beyond the packet

- How is decision-making power shared with the communities served? (Trust-based funders weight this heavily.)
- What is the ratio of board members representing the communities served vs. external?
- Compensation ratio (highest-paid to lowest-paid staff).
- Any audit findings or material weaknesses in past 3 years?
- Pending or threatened litigation?
- Any related-party transactions disclosed on Schedule L?

---

## 5. Fiscal Sponsorship Interim Path
...
- Sponsor has discretion and variance power; project has operational autonomy.
...
| Sponsor | Fee | Notes |
|---|---|---|
| **Players Philanthropy Fund (PPF)** | **6%** of donations | Both Model A and Model C; clean, fast, sports/cause-agnostic; widely used by athletes and athletes-adjacent founders |
| **Hack Club Bank / HCB** | **7%** | Open-source operations; strong for tech/builder culture; primarily hackathons and student clubs but accepts broader missions |
| **Social Good Fund** | **6–8%** + $29/mo refundable admin | Receives ~1,000 applications/year, capacity for ~100. CA-based; strong for grassroots social justice. No application fee |
| **Tides Center** | **9%** | Largest progressive sponsor; full-service; ~130 projects |
| **FJC (NY)** | **6–9%** | Boutique; offers donor-advised funds + impact investing alongside sponsorship |
| **Earth Island Institute** | ~9% | 75+ environmental projects; longstanding |
...
| Pro of fiscal sponsorship | Con |
|---|---|
| Tax-deductible giving from day one | 6–9% leakage on every dollar |
| Sponsor handles 990, payroll, audit | Less control over funds; sponsor has variance power |
| Bridges the IRS Determination wait | Funder perception: "real" 501(c)(3)s are taken more seriously by some institutional funders |
| Insurance, HR, accounting inherited | Sponsor's reputation risk attaches to HAND |
| Easier to wind down if pivot is needed | Some foundations (e.g., MacKenzie Scott) prefer direct grantees |

### Decision matrix

- **If HAND files 1023 in 2026 and expects determination by mid-2027:** fiscal sponsorship for ~12–18 months via PPF or HCB is reasonable.
- **If HAND wants to be in MacKenzie Scott / Yield Giving's pipeline:** prioritize direct 501(c)(3) status; sponsorship may slow that.
- **If the $222,222 incorporation campaign closes within 90 days:** skip sponsorship, file 1023 directly, and use the 27-month retroactive window for any pre-determination gifts.

---

## 6. Board Governance Best Practices

### BoardSource's Twelve Principles of Governance That Power Exceptional Boards
...
### Board size and term structure for small founder-led nonprofits

- **Minimum size:** Texas requires 3; **most experts recommend 5–7 for small founder-led orgs**, scaling to 9–15 as the org matures. Median nonprofit board size is 15, but effectiveness research suggests **≤8 active members for high-quality deliberation**.
- **Term length:** **Two consecutive three-year terms** is the BoardSource-recommended standard. Total 6 years, with mandatory rotation off (option to return after a 1-year "rest" period).
- **Staggered terms:** No more than **one-third of seats** should expire in any given year. This preserves institutional memory and prevents capture or coup risk.
- **Founder dynamic:** founders frequently stay on the board longer than would be ideal; mature boards mitigate this with (a) clear separation of board chair from founder/ED; (b) annual ED performance review by the board (with founder recused if on board); (c) explicit succession planning.
...
### Where the Executive Director sits
...
Reference: `aprioboardportal.com/news/ex-officio-board-member-role-and-responsibilities/`; `boardsource.org`.

---

## 7. Founder/ED Succession and Replacement Procedures

Mature governance distinguishes four scenarios, each with its own protocol:

### A. Emergency ED succession

Triggered by sudden incapacity, death, or unplanned departure. Bridgespan, Propel Nonprofits, and CompassPoint all publish templates.
...
Templates: Propel Nonprofits (`propelnonprofits.org`); Bridgespan succession planning library (`bridgespan.org/insights/succession-planning`).

### B. Planned ED transition
...
The hardest case. Bridgespan's "Four Case Studies of Founder Transitions" is the leading reference.

Common pitfalls:

- Founder remains on board and undermines successor; mitigation: founder takes a **mandatory 1-year off-board sabbatical** before any board role.
- Brand is fused with founder; mitigation: deliberate **brand decoupling work** during founder's last 18 months.
- Donors loyal to founder, not org; mitigation: founder makes **explicit handoff introductions** and writes a public succession message.
- Successor compared unfairly; mitigation: board explicitly resets metrics for the new ED.

### D. Board Chair succession

- **Vice Chair pathway:** the vice chair is the designated successor; serves a 1–2 year apprenticeship.
- **Term limits:** chair typically serves 1–3 year term, optionally renewable once.
- **Avoid:** chair-for-life dynamics, which create founder-syndrome-by-proxy.

### E. Director removal

Bylaws should specify removal procedures. Texas BOC §22.211 allows removal of a director with or without cause unless the certificate of formation provides otherwise.
...
## 8. Texas-Specific Compliance Beyond Incorporation
...
## 9. Multi-State Charitable Solicitation

### When does HAND need to register elsewhere?

**41 states + DC** require some form of charitable solicitation registration. Triggering activities typically include: maintaining a paid solicitor in the state, mailing a printed appeal to state residents, or accepting substantial donations from state residents on a repeated basis.

### The Charleston Principles (2001, NASCO/NAAG)
...
### What responsible-AI funders look for
...
### Practical deliverables for HAND to produce
